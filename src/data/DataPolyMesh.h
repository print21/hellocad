...
namespace data
{
	...
	public:
		...
		typedef core::VectorT<double, 4> Color;
		...
		virtual std::vector<Color> edgeColor(Index id) const override;
		...
		virtual std::vector<Color> faceColor(Index id) const override;
